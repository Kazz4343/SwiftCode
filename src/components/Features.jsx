...
const Features = () => {
    return (
        <section id='features' className="py-16 md:py-20 px-10 sm:px-6 lg:px-8 relative" >
                ...
                <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition === 'right' ? 'lg:flex-row-reverse' : '' }`}>
                  ...
                  <div className="flex-1 w-full">
                    <div className="relative group">
                      ...
                      />
                      <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/. 
                        50 rounded-xl sm:rounded-2xl p-4 sm:p-6 overflow-hidden group-hover:border 
                      ...
                      >
                        ...
                        <div className="bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-xs sm:text-sm">
                            <div className="flex items-center space-x-1 sm:space-x-2 mb-3 sm:sm-4">
